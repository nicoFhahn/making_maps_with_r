...
```
```{r, echo=FALSE}
htmltools::tags$iframe(src = "html_plots/tmap_1.html", width = "910px", height = "700px")
```
...
```
```{r, echo=FALSE}
htmltools::tags$iframe(src = "html_plots/tmap_2.html", width = "910px", height = "700px")
```
...
```
```{r, echo=FALSE}
htmltools::tags$iframe(src = "html_plots/tmap_3.html", width = "910px", height = "700px")
```
...
```
```{r, echo=FALSE}
htmltools::tags$iframe(src = "html_plots/tmap_4.html", width = "910px", height = "700px")
```
