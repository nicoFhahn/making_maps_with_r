...
```
```{r, echo=FALSE}
htmltools::tags$iframe(src = "html_plots/mapview_1.html", width = "910px", height = "700px")
```
...
```
```{r, echo=FALSE}
htmltools::tags$iframe(src = "html_plots/mapview_2.html", width = "910px", height = "700px")
```
...
```
```{r, echo=FALSE}
htmltools::tags$iframe(src = "html_plots/mapview_3.html", width = "910px", height = "700px")
```
...
```
```{r, echo=FALSE}
htmltools::tags$iframe(src = "html_plots/mapview_4.html", width = "910px", height = "700px")
```
...
```
```{r, echo=FALSE}
htmltools::tags$iframe(src = "html_plots/mapview_5.html", width = "910px", height = "700px")
```
