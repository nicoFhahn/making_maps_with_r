...
```{r, fig.align="center", fig.cap="Arbeitslosenquote in Bayern, 2015", fig.height=9}
...
```{r, fig.align="center", fig.cap="Mehrere Ebenen übereinander", warning=FALSE, message=FALSE, fig.height=9}
...
```{r, fig.align="center", fig.cap="Flughäfen und Autobahnen in Bayern", fig.height=9}
...
```{r, fig.align="center", fig.cap="Benutzerdefinierte Popups", fig.height=9}
...
```{r, fig.align="center", fig.cap="Grafiken als Popups", fig.height=9}
