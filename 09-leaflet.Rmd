...
```{r, include=FALSE}
htmltools::tags$iframe(src = "html_plots/leaflet_1.html", width = "910px", height = "700px")
```
...
```{r, include=FALSE}
htmltools::tags$iframe(src = "html_plots/leaflet_2.html", width = "910px", height = "700px")
```

Eine Erweiterung des **leaflet** Pakets ist **leaflet.extras**. Mit diesem lassen sich beispielsweise Heatmaps darstellen. Mit `addMeasure()` wird hier noch ein Maßband hinzugefügt, mit dem Distanz zwischen zwei Punkten oder die Fläche zwischen mehreren Punkten berechnet werden kann.
...
```
```{r, include=FALSE}
htmltools::tags$iframe(src = "html_plots/leaflet_3.html", width = "910px", height = "700px")
```
...
```
```{r, echo=FALSE}
htmltools::tags$iframe(src = "html_plots/leaflet_js.html", width = "910px", height = "700px")
```
...
```{r, echo=FALSE}
htmltools::tags$iframe(src = "html_plots/leaflet_js2.html", width = "910px", height = "700px")
```
