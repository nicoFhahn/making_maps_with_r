...
library(readr)
library(leaflet)
coords <- read_csv("../datasets/leaflet_data/coords_1.csv")
isochrone <- read_sf("../datasets/leaflet_data/isochrone_1.shp")
poly_data <- read_sf("../datasets/leaflet_data/poly_data_1.shp")
points <- read_sf("../datasets/leaflet_data/points_1.shp")
...
```{r, include = FALSE}
intersect <- read_sf("../datasets/leaflet_data/intersect_2.shp")
points_df <- read_csv("../datasets/leaflet_data/points_df_2.csv")
polygons <- read_sf("../datasets/leaflet_data/polygons_2.shp")
```
...
```{r, include = FALSE}
points_df <- read_csv("../datasets/leaflet_data/points_df_3.csv")
streets_c <- read_sf("../datasets/leaflet_data/streets_c_3.shp")
