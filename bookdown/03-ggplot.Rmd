...
honey <- read_sf("../datasets/chapter_3/honey.shp")
...
```{r, fig.cap="Basic use of ggplot2 for spatial data"}
...
```{r, fig.cap="Adding a basemap and some elements"}
