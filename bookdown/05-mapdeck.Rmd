...
```{r, echo=FALSE}
htmltools::includeHTML("html_plots/chapter_5/mapdeck1.html")
```
...
```{r, echo=FALSE}
htmltools::includeHTML("html_plots/chapter_5/mapdeck2.html")
```
...
```{r, echo=FALSE}
htmltools::includeHTML("html_plots/chapter_5/mapdeck3.html")
```
...
```
```{r, echo=FALSE}
htmltools::includeHTML("html_plots/chapter_5/mapdeck4.html")
```
...
```{r, echo=FALSE}
htmltools::includeHTML("html_plots/chapter_5/mapdeck5.html")
``` 
...
```{r, echo=FALSE}
htmltools::includeHTML("html_plots/chapter_5/mapdeck6.html")
```
...
```
```{r, echo=FALSE}
htmltools::includeHTML("html_plots/chapter_5/mapdeck7.html")
```
...
```
```{r, echo=FALSE}
htmltools::includeHTML("html_plots/chapter_5/mapdeck8.html")
```
...
```
```{r, echo=FALSE}
htmltools::includeHTML("html_plots/chapter_5/mapdeck9.html")
```
...
```
```{r, echo=FALSE}
htmltools::includeHTML("html_plots/chapter_5/mapdeck10.html")
```
