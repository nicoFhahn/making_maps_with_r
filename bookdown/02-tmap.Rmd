...
ba4 <- tm_shape(bavaria) +
  tm_polygons(col = "unemployment_rate", style = "pretty", title = "Aq") +
  tm_credits('style = "pretty"', size = 1) +
  tm_layout(inner.margins = 0.1)
ba5 <- tm_shape(bavaria) +
  tm_polygons(col = "unemployment_rate", style = "equal", title = "Aq") +
  tm_credits('style = "equal"', size = 1) +
  tm_layout(inner.margins = 0.1)
ba6 <- tm_shape(bavaria) +
  tm_polygons(col = "unemployment_rate", style = "quantile", title = "Aq") +
  tm_credits('style = "quantile"', size = 1) +
  tm_layout(inner.margins = 0.1)
ba7 <- tm_shape(bavaria) +
  tm_polygons(col = "unemployment_rate", style = "jenks", title = "Aq") +
  tm_credits('style = "jenks"', size = 1) +
  tm_layout(inner.margins = 0.1)
ba8 <- tm_shape(bavaria) +
  tm_polygons(col = "unemployment_rate", style = "cont", title = "Aq") +
