...
```{r, echo=FALSE}
htmltools::tags$iframe(src = "html_plots/chapter_6/leaflet_1.html", width = "700px", height = "700px")
```
...
```{r, echo=FALSE}
htmltools::tags$iframe(src = "html_plots/chapter_6/leaflet_2.html", width = "700px", height = "700px")
```
...
```{r, echo=FALSE}
htmltools::tags$iframe(src = "html_plots/chapter_6/leaflet_3.html", width = "700px", height = "700px")
```
...
```{r, echo=FALSE}
htmltools::tags$iframe(src = "html_plots/leaflet_4.html", width = "700px", height = "700px")
```
...
```
```{r, echo=FALSE}
htmltools::tags$iframe(src = "html_plots/leaflet_5.html", width = "700px", height = "700px")
```
...
```{r, echo=FALSE}
htmltools::tags$iframe(src = "html_plots/leaflet_6.html", width = "700px", height = "700px")
```
