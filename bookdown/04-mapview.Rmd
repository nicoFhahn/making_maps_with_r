...
```{r, fig.align="center", fig.cap="A basic map using mapview", fig.height=9, eval=FALSE}
mapview(bavaria)
```
```{r, echo=FALSE}
htmltools::tags$iframe(src = "html_plots/chapter_4/mapview_1.html", width = "700px", height = "700px")
```
...
```{r, fig.align="center", fig.cap="zcol for coloring", fig.height=9, eval=FALSE}
mapview(bavaria, zcol = "unemployment_rate")
```
```{r, echo=FALSE}
htmltools::tags$iframe(src = "html_plots/chapter_4/mapview_2.html", width = "700px", height = "700px")
```

If we want to use a custom palette, we can define one and then use the `col.regions` argument.

```{r, fig.align="center", fig.cap="Using a custom palette", fig.height=9, eval=FALSE}
pal <- viridis::magma(n = length(unique(bavaria$employment_rate)), direction = -1)
mapview(bavaria, zcol = "unemployment_rate", col.regions = pal)
```
```{r, echo=FALSE}
htmltools::tags$iframe(src = "html_plots/chapter_4/mapview_6.html", width = "700px", height = "700px")
```

The `at` argument can be used to define your own breakpoints.

```{r, fig.align="center", fig.cap="Defining breakpoints manually", fig.height=9, eval=FALSE}
mapview(bavaria, zcol = "unemployment_rate", col.regions = vapoRwave::jazzCup_pal(), at = c(0, 2, 4, 6, 8))
```
```{r, echo=FALSE}
htmltools::tags$iframe(src = "html_plots/chapter_4/mapview_7.html", width = "700px", height = "700px")
```
...
```{r, fig.align="center", fig.cap="Using multiple layers", warning=FALSE, message=FALSE, fig.height=9, eval=FALSE}
mapview(europe_raster, legend = FALSE) +
  mapview(europe_shape, legend = FALSE, alpha.regions = 0) +
  mapview(cities, legend = FALSE, cex = "pop")
```
```{r, echo=FALSE}
htmltools::tags$iframe(src = "html_plots/chapter_4/mapview_3.html", width = "700px", height = "700px")
```
...
```{r, fig.align="center", fig.cap="Focusing on layers", fig.height=9, eval=FALSE}
...
```
```{r, echo=FALSE}
htmltools::tags$iframe(src = "html_plots/chapter_4/mapview_4.html", width = "700px", height = "700px")
```
...
```{r, fig.align="center", fig.cap="Custom popups", fig.height=9, eval=FALSE}
mapview(bavaria, zcol = "admin_district", col.regions = brewer.pal(7, "Dark2"),
        popup = popupTable(bavaria, zcol = c("unemployment_rate",
                                             "household_income",
                                             "pop_density")))
```
```{r, echo=FALSE}
htmltools::tags$iframe(src = "html_plots/chapter_4/mapview_5.html", width = "700px", height = "700px")
```
...
```{r, fig.align="center", fig.cap="Using plots as popups", fig.height=9, eval=FALSE}
mapview(bavaria, zcol = "unemployment_rate", col.regions = pal, popup = popupGraph(p))
```
```{r, echo=FALSE}
htmltools::tags$iframe(src = "html_plots/chapter_4/mapview_9.html", width = "700px", height = "700px")
```
