...
# Karten mit mapdeck
**mapdeck** ist ein R-Paket mit dem interaktive Karten unter Verwendung von *mapbox GL* und *Deck.gl* erstellt werden können. Mapbox ist eine Standortdaten Plattform mit der verschiedene Applikationen erstellt werden können. Deck.gl ist ein Framework zur Visualierung großer Datensätze. Für die Verwendung des Pakets wird allerdings ein Mapbox-Token benötigt, der mit `set_token("token")` gesetzt wird. Alternativ kann diese auch bei jeder Grafik manuell gesetzt werden. Um einen solchen Token zu erhalten, muss ein Konto auf https://www.mapbox.com/ eingerichtet werden.
